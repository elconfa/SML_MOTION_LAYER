...
| File | Ruolo |
|---|---|
| `GVL_SML_CONST` | costanti: `MAX_AXIS`, `PROGRESS_SPAN`, `MAP_SIZE_*` |
...
### I/O verso il drive (vedi `GUIDA_IO_Linking.md`)
| File | Ruolo |
|---|---|
...
4. **I/O**: collega `GVL_AXIS.Axis[n]` ai PDO del drive — vedi `GUIDA_IO_Linking.md`
